...
var _FrameTicker = require('frame-ticker');
...
var _FrameTicker__default = /*#__PURE__*/_interopDefaultLegacy(_FrameTicker);
...
var GlobeLayerKapsule = Kapsule__default["default"]({
  ...
  stateInit: function stateInit() {
    ...
    var graticulesObj = new THREE$e.LineSegments(new threeGeojsonGeometry.GeoJsonGeometry(d3Geo.geoGraticule10(), GLOBE_RADIUS, 2), new THREE$e.LineBasicMaterial({
      color: 'lightgrey',
      transparent: true,
      opacity: 0.1
    }));
...
var FrameTicker$2 = _FrameTicker__default["default"]["default"] || _FrameTicker__default["default"];
  ...
  update: function update(state) {
    ...
    function calcCurve(_ref) {
      ...
      if (altitude) {
        ...
        var curve = _construct(THREE$c.CubicBezierCurve3, _toConsumableArray([startPnt, m1Pnt, m2Pnt, endPnt].map(getVec))); //const mPnt = [...interpolate(0.5), altitude * 2];
    ...
    function calcColorVertexArray(colors, numSegments) {
      ...
      if (colors instanceof Array || colors instanceof Function) {
        var colorInterpolator = colors instanceof Array ? d3Scale.scaleLinear() // array of colors, interpolate at each step
...
var FrameTicker$1 = _FrameTicker__default["default"]["default"] || _FrameTicker__default["default"];
// support both modes for backwards threejs compatibility
...
var FrameTicker = _FrameTicker__default["default"]["default"] || _FrameTicker__default["default"];
var RingsLayerKapsule = Kapsule__default["default"]({
  props: {
    ringsData: {
      "default": []
    },
  ...
  init: function init(threeObj, state) {
    ...
    new FrameTicker().onTick.add(function (time) {
      ...
      var colorAccessor = accessorFn__default["default"](state.ringColor);
      var altitudeAccessor = accessorFn__default["default"](state.ringAltitude);
      var maxRadiusAccessor = accessorFn__default["default"](state.ringMaxRadius);
      var propagationSpeedAccessor = accessorFn__default["default"](state.ringPropagationSpeed);
      var repeatPeriodAccessor = accessorFn__default["default"](state.ringRepeatPeriod);
      state.ringsData.filter(function (d) {
        ...
        if ((obj.__nextRingTime || 0) <= time) {
          ...
          if (!isMultiColor) {
            ...
            if (colors instanceof Array) {
              colorInterpolator = d3Scale.scaleLinear().domain(colors.map(function (_, idx) {
                return idx / (colors.length - 1);
              })) // same number of stops as colors
              .range(colors);
  ...
  update: function update(state) {
    // Data accessors
    var latAccessor = accessorFn__default["default"](state.ringLat);
    var lngAccessor = accessorFn__default["default"](state.ringLng);
    var altitudeAccessor = accessorFn__default["default"](state.ringAltitude);
...
: {}), {}, {
  CSS2DObject: CSS2DRenderer_js.CSS2DObject
});

var HtmlElementsLayerKapsule = Kapsule__default["default"]({
  props: {
    htmlElementsData: {
      "default": []
    },
  ...
  update: function update(state, changedProps) {
    ...
    // Data accessors
    var latAccessor = accessorFn__default["default"](state.htmlLat);
    var lngAccessor = accessorFn__default["default"](state.htmlLng);
    var altitudeAccessor = accessorFn__default["default"](state.htmlAltitude);
    var elemAccessor = accessorFn__default["default"](state.htmlElement);
    threeDigest(state.htmlElementsData, state.scene, {
      ...
      updateObj: function updateObj(obj, d) {
        ...
        if (!state.htmlTransitionDuration || state.htmlTransitionDuration < 0 || !obj.__currentTargetD) {
          ...
          // animate
          new TWEEN__default["default"].Tween(obj.__currentTargetD).to(targetD, state.pointsTransitionDuration).easing(TWEEN__default["default"].Easing.Quadratic.InOut).onUpdate(applyUpdate).start();
        }
      }
    });
  }
...
var ObjectsLayerKapsule = Kapsule__default["default"]({
  props: {
    objectsData: {
      "default": []
    },
  ...
  update: function update(state, changedProps) {
    // Data accessors
    var latAccessor = accessorFn__default["default"](state.objectLat);
    var lngAccessor = accessorFn__default["default"](state.objectLng);
    var altitudeAccessor = accessorFn__default["default"](state.objectAltitude);
    var threeObjAccessor = accessorFn__default["default"](state.objectThreeObject);
    ...
    var initGlobe = function initGlobe() {
      if (animateIn) {
        ...
        new TWEEN__default["default"].Tween({
          ...
          k: 1
        }, 600).easing(TWEEN__default["default"].Easing.Quadratic.Out).onUpdate(function (_ref16) {
          var k = _ref16.k;
        ...
        new TWEEN__default["default"].Tween({
          ...
          rot: 0
        }, 1200).easing(TWEEN__default["default"].Easing.Quintic.Out).onUpdate(function (_ref17) {
          var rot = _ref17.rot;
