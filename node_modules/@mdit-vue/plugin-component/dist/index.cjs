...
const HTML_SELF_CLOSING_TAG_RE = new RegExp("^<[A-Za-z][A-Za-z0-9\\-]*" + attribute + "*\\s*\\/>");
const HTML_OPEN_AND_CLOSE_TAG_IN_THE_SAME_LINE_RE = new RegExp("^<([A-Za-z][A-Za-z0-9\\-]*)" + attribute + "*\\s*>.*<\\/\\1\\s*>");
...
const createHtmlSequences = ({
  ...
  const HTML_SEQUENCES = [
    ...
    [
      new RegExp("^</?(?!(" + forceInlineTags.join("|") + ")(?![\\w-]))\\w[\\w-]*[\\s/>]"),
      /^$/,
      true
    ],
